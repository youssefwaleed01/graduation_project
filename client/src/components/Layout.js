...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex h-16 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <button
          type="button"
          className="px-4 border-r border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 lg:hidden transition-colors"
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:flex lg:flex-shrink-0 lg:fixed lg:left-0 lg:top-16 lg:h-screen lg:z-30">
...
const SidebarContent = ({ navigation, isActive }) => {
  ...
  return (
    <div className="flex flex-col h-full border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 w-full">
            ...
            return (
              <div key={item.name} className="space-y-1">
                <button
                  ...
                  className={`${
                    hasActiveChild || isParentItemActive
                      ...
                      <button
                        ...
                        className={`${
                          isActive(child.href)
                            ...
                            : 'text-gray-600 dark:text-gray-400 border-l-2 border-transparent hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:border-l-2 hover:border-primary-300 dark:hover:border-primary-600'
